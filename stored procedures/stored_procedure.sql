...
BEGIN
    ...
    UPDATE POSTS SET COMMENTSCOUNT = COMMENTSCOUNT + 1 WHERE POST_ID = PI_POST_ID;
...
BEGIN
    ...
    UPDATE POSTS SET LIKESCOUNT = LIKESCOUNT + 1 WHERE POST_ID = PI_POST_ID;
...
BEGIN
    ...
    UPDATE POSTS SET LIKESCOUNT = LIKESCOUNT - 1 WHERE POST_ID = PI_POST_ID AND LIKESCOUNT > 0;
